...
def random_list_user():
    ...
    for i in range(0, len(images)):
        ...
        if(images[i].split(".")[-1] == "jpg"):
            ...
            encoded_img_b64 = base64.b64encode(imageSource.read())
            base64_string = encoded_img_b64.decode("utf-8")

            identification["image"] = base64_string
            ...
            general_info["birthdate"] = datetime.date(
                randint(1980, 2010), randint(1, 12), randint(1, 28))
